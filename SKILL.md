...
description: Use when 用户使用中文、要求简体中文输出、项目约定中文交流，或需要审计/约束 Claude Code 的中文回复、中文文档、中文注释、中文 Git 信息、计划、终端提示与可见 thinking；允许保留代码标识符、API、路径、命令、错误原文和必要技术术语。
---
...
**thinking 块第一句固定为 "好的，→ 用中文思考。"**——这是语言切换锚点。若用户明确要求英文产物，以用户当前请求为准。
...
**所有面向人类的文本默认使用简体中文。英文仅用于技术强制场景，或用户明确要求英文产物时。违反字面规则即违反规则精神。**
